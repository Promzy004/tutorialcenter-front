    ...
    return (
        <>
            <div className="bg-primary py-3 relative xl:max-w-[1300px] w-full mx-auto 2xl:px-9 lg:px-8 px-5 mb-20">
                ...
                <img src={icon} alt="Tutorial center" className={`absolute bottom-0 translate-y-16 lg:translate-y-20 ${position_right ? "right-10 md:right-20" : "left-10 md:left-20"} w-[80px] lg:w-[100px]`} />
            </div>
        </>
    );
}
